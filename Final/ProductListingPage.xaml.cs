...
namespace ContosoElectronics
{
    ...
    public sealed partial class ProductListingPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            this.defaultViewModel["PageName"] = await CategoryDataSource.GetSubCategoryNameAsync(e.NavigationParameter.ToString());           
        }
        ...
        /// <summary>
        /// Handles the OnItemClick event of the ItemGridView control.
        /// </summary>
